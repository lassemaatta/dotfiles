...
#+begin_src emacs-lisp
  (use-package spell-fu
    ...
    (spell-fu-dictionary-add (spell-fu-get-ispell-dictionary "fi"))
    (spell-fu-dictionary-add
     (spell-fu-get-personal-dictionary "en-personal" "/home/lassemaatta/.fu_spell_personal"))
    (defun my-spell-org ()
      ...
      (spell-fu-mode))
    :custom
    (ispell-personal-dictionary "~/.spell_fu_personal")
    (spell-fu-global-ignore-buffer (lambda (buf) (buffer-local-value 'buffer-read-only buf)))
    :custom-face
    (spell-fu-incorrect-face ((((supports :underline (:style wave))) :underline (:style wave :color "#feacd0"))
                              (t :underline t :inherit error)))
    :hook ((clojure-mode . spell-fu-mode)
           (org-mode . my-spell-org)))
#+end_src
