...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package doom-modeline
    :custom
    (doom-modeline-vcs-max-length 17)
...
#+BEGIN_SRC emacs-lisp
  (custom-set-faces
     '(mode-line ((t (:family "Dejavu Sans Mono" :height 0.9))))
     '(mode-line-active ((t (:family "Dejavu Sans Mono" :height 0.9))))
     '(mode-line-inactive ((t (:family "Dejavu Sans Mono" :height 0.9)))))
#+END_SRC
