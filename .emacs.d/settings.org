...
#+begin_src emacs-lisp
  ...
  (my-leader-def
    ...
    "bP" '(consult-project-buffer :which-key "Project buffers")
    ...
    "ll" '(eval-last-sexp :which-key "Eval last")
    "le" '(eval-defun :which-key "Eval defun"))
...
#+BEGIN_SRC emacs-lisp
  (use-package lsp-mode
    ...
    :hook (;; replace XXX-mode with concrete major-mode(e. g. python-mode)
           ...
           (lsp-after-open . my-refresh-completions)
