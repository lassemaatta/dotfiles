...
Enable smooth scrolling when using macos.
...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'variable-pitch nil :family font-family-variable :height 1.2)
...
#+begin_src emacs-lisp
  ...
  (use-package button-lock
    ...
    :hook ((clojure-mode
            magit-revision-mode) . my-toggle-jira-buttons))
#+end_src
