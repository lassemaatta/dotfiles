...
#+BEGIN_SRC emacs-lisp
  (use-package swiper
    ...
    :config
    (progn
      ;; Use a single <esc> press to close minibuffer while searching
...
#+BEGIN_SRC emacs-lisp
  (use-package company
    ...
    ;; Fix issue where <enter> after typing would choose the first completion suggestion
    ;; See https://emacs.stackexchange.com/a/24800
